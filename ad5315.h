...
#define AD5315_SLA_W 0x18
#define AD5315_SLA_R 0x19

void AD5315_Write(unsigned char pd0, 
...
unsigned int AD5315_Read(unsigned char chan)
{
    unsigned int data = 0;
